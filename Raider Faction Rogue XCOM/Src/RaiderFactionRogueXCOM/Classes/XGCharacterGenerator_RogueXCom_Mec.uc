class XGCharacterGenerator_RogueXCom_Mec extends XGCharacterGenerator;
...
function TSoldier CreateTSoldier( optional name CharacterTemplateName, optional EGender eForceGender, optional name nmCountry = '', optional int iRace = -1, optional name ArmorName )
{
	...
	kSoldier.kAppearance.nmTorso = 'RogueXComMec_Torso_M2';
	kSoldier.kAppearance.nmArms = 'RogueXComMec_Arms_M2';
	kSoldier.kAppearance.nmLegs = 'RogueXComMec_Legs_M2';
		...
		kSoldier.kAppearance.nmFacePropUpper = (kSoldier.kAppearance.iGender == eGender_Female) ? 'Aviators_F' : 'Aviators_M';
